...
export async function GET(request: Request) {
  try {
    ...
    let apiUrl = `${NEYNAR_API_BASE}/following?fid=${fidNumber}&limit=${limit}`;
    ...
    console.log("Fetching following from Neynar URL:", apiUrl);
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: `Failed to fetch following: ${errorText}` },
